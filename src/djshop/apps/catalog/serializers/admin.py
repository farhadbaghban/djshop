...
class CategoryTreeSerializer(serializers.ModelSerializer):
    ...
    """we cant use CategoryTreeSerializer in this place"""

    # @extend_schema_field(serializers.ListField(child = CategoryTreeSerializer()))
...
CategoryTreeSerializer.get_children = extend_schema_field(
    serializers.ListField(child=CategoryTreeSerializer())
